  ...
  >
    ...
    >
      <el-time-select
        style="width: 112px"
        placeholder="起始"
        v-model="reserveForm.unUseStartTime"
        :picker-options="{
          start: '00:00',
          step: '01:00',
          end: '24:00',
          maxTime: reserveForm.unUseEndTime
        }"
      >
      </el-time-select>
      --
      <el-time-select
        style="width: 112px"
        placeholder="结束"
        v-model="reserveForm.unUseEndTime"
        :picker-options="{
          start: '00:00',
          step: '01:00',
          end: '24:00',
          minTime: reserveForm.unUseStartTime
        }"
      >
      </el-time-select>
    </el-form-item>
...
export default {
  ...
  watch: {
    reserveForm: {
      handler(nval, oval) {
        const { startTime, endTime,unUseStartTime,unUseEndTime } = nval;

        this.$emit("update:newObj", {
          ...nval,
          startTime: startTime ? startTime + ":00" : null,
          endTime: endTime ? endTime + ":00" : null,
          unUseStartTime: unUseStartTime ? unUseStartTime + ":00" : null,
          unUseEndTime: unUseEndTime ? unUseEndTime + ":00" : null
        });
      },
      immediate: true,
      deep: true
